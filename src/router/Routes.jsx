        ...
        children: [
            {
                ...
                loader: ({params}) => fetch(`https://the-dragon-news-server-sakibmohammad79.vercel.app/catagories/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                loader:({params}) => fetch(`https://the-dragon-news-server-sakibmohammad79.vercel.app/news/${params.id}`)
            },
        ]
    }
])
